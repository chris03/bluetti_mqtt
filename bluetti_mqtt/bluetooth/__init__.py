...
from bluetti_mqtt.core import BluettiDevice, AC200M, AC240, AC300, AC500, AC60, EP500, EP500P, EP600, EB3A
...
DEVICE_NAME_RE = re.compile(r'^(AC200M|AC240|AC300|AC500|AC60|EP500P|EP500|EP600|EB3A)(\d+)$')
